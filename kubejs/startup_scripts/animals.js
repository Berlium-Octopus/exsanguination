...
BlockEvents.modification(event => {
  let SUS = new SoundType(1, 1, $SculkSound.SOUL_HARVESTER_ITEM_INSERTED.get(), "minecraft:block.sculk.step", "minecraft:block.sculk.place", "minecraft:block.sculk.hit", "minecraft:block.suspicious_gravel.fall")
  event.modify('deeperdarker:suspicious_sculk_grime', block => {
    block.setSoundType(SUS)
  })
})
...
StartupEvents.registry('item', event => {
  ...
  event.createCustom('deeperdarker:warden_horse_armor', () => new $HorseArmorItem['(int,net.minecraft.resources.ResourceLocation,net.minecraft.world.item.Item$Properties)'](11, 'kubejs:textures/entity/horse/armor/horse_armor.png', (new $IProperties()).stacksTo(1)))
  event.createCustom('deeperdarker:resonarium_horse_armor', () => new $HorseArmorItem['(int,net.minecraft.resources.ResourceLocation,net.minecraft.world.item.Item$Properties)'](11, 'kubejs:textures/entity/horse/armor/horse_armor.png', (new $IProperties()).stacksTo(1)))
