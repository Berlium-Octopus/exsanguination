...
ServerEvents.tags('spartanweaponry:weapon_traits', event => {
  ...
  event.remove("spartanweaponry:materials/silver", 'spartanweaponry:undead_damage_bonus')
})
...
ServerEvents.tags('item', event => {
  ...
  event.add('storms_of_the_wild:conductive_item', ["cataclysm:ignitium_helmet",
    ...
    "spartanweaponry:tipped_netherite_arrow",
    ...
    "archeological:netherite_charm",
    "netherexp:netherite_plating",
    "netherexp:netherite_plated_block",
    "netherexp:netherite_grate",
    "netherexp:cut_netherite_block",
    ...
    "spartanweaponry:tipped_iron_arrow",
    ...
    "archeological:rusty_hoe",
    "archeological:rusty_sword",
    "archeological:rusty_coin",
    ...
    "archeological:golden_coin",
    "immersive_weathering:golden_moss_clump",
    "luminous_nether:gold_cultist_axe",
    "alexscavesdelight:heart_of_iron_humburger",
    "alexscavesdelight:filled_heart_of_iron",
    ...
    "spartanweaponry:tipped_copper_arrow",
...
ServerEvents.tags('entity_type', event => {
  ...
  event.add('storms_of_the_wild:conductive_entities',
